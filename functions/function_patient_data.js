...
app.get("/patient_data/:systemkeyval/patient_case_id/:registration_code_val/patient_lastname/:surname_val/voucher_code/:voucher_code_val", (req, res) => {
    ...
    connection_to_itisdb.query(queryString, [systemkeyval], (err, rows, fields) => {
        ...
        if (systemkey_num == 1) {
            ...
            var queryWhere1 = "WHERE tb_case.registrationCode = ? AND patient.lastName = ? AND tb_case.voucher_code = ? ";
            ...
            connection_to_itisdb.query(Patient_dataquery, [PATIENT_REGISTRATIONCODE, PATIENT_SURNAME, PATIENT_VOUCHER_CODE], (err, rows, fields) => {
